 ...
 * </p>
 * <ul>
 *   <li>{@link es.uca.mps.santiago_godoy.family.impl.FamilyImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uca.mps.santiago_godoy.family.impl.FamilyImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FamilyImpl extends MinimalEObjectImpl.Container implements Family {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamilyPackage.FAMILY__NAME, oldName, name));
	}
